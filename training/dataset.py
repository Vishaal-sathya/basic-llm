"""
Creates an iterable dataset using the pytorch Dataset and Dataloader classes.
Creates input-output pairs for the llm to train on
"""

# GPTDataset pg 59

# create data loader pg 60
